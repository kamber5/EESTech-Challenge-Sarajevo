...
class MainPageScreen extends GetWidget<MainPageController> {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: Container(
                ...
                padding: getPadding(left: 12, top: 1, right: 12, bottom: 1),
                child: Column(
                      ...
                      Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                CustomImageView(
                                    svgPath:
                                        ImageConstant.imgSuperskillstransparent,
                                    height: getSize(104),
                                    width: getSize(104)),
                                Padding(
                          ...
                          child:
                            ...
                            Align(
                                ...
                                child: GestureDetector(
                                    ...
                                    child: Container(
                                        margin: getMargin(left: 25, right: 20),
                                        padding: getPadding(
                                            left: 10,
                                            top: 16,
                                            right: 10,
  ...
  onTapColumnplaygame() {
    Get.toNamed(AppRoutes.pickObjectiveContainerScreen);
  }
}
