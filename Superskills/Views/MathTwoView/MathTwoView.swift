...
struct MathTwoView: View {
    @StateObject var mathTwoViewModel = MathTwoViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                    ...
                    VStack {
                        VStack(alignment: .trailing, spacing: 0) {
                                    ...
                                    HStack {
                                        Text(StringConstants.kLblMath)
                                            ...
                                            .frame(width: 95.0, height: getRelativeHeight(38.0),
                                                   alignment: .center)
                                            .shadow(color: ColorConstants.Black90059, radius: 6,
                                                    x: 5, y: 5)
                                        VStack {
                                            ZStack {}
                                                .hideNavigationBar()
                            ...
                            VStack(alignment: .leading, spacing: 0) {
                                Text(StringConstants.kMsgHowIsNumber2)
                                    .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(35.0)))
                                    .fontWeight(.regular)
                                    .foregroundColor(ColorConstants.Black900)
                                    .minimumScaleFactor(0.5)
                                    .multilineTextAlignment(.center)
                                    .frame(width: 297.0, height: getRelativeHeight(100.0),
                                           alignment: .center)
                                    ...
                                    VStack {
                                        LazyVGrid(columns: [SwiftUI.GridItem(), SwiftUI.GridItem()],
                                            ...
                                            ForEach(0 ... 3, id: \.self) { index in
                                                Stackvector2Cell(vectorClick: {
                                                    mathTwoViewModel.nextScreen = "MathOneView"
                                                })
                                            }
                                        }
                                    }
                            ...
                            .frame(width: 314.0, height: getRelativeHeight(359.0),
                                   alignment: .center)
                ...
                Group {
                    NavigationLink(destination: MathOneView(),
                                   tag: "MathOneView",
                                   selection: $mathTwoViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct MathTwoView_Previews: PreviewProvider {
