                ...
                VStack {
                    VStack(alignment: .trailing, spacing: 0) {
                        HStack {
                            ...
                            .frame(width: 32.0, height: getRelativeHeight(24.0), alignment: .center)
                            .padding(.top, getRelativeHeight(20.0))
                            .padding(.bottom, getRelativeHeight(23.0))
                        }
                        .frame(width: 295.0, height: getRelativeHeight(67.0), alignment: .center)
                        .padding(.leading)
                        .padding(.leading)
                        ...
                        .frame(width: 314.0, height: getRelativeHeight(315.0), alignment: .center)
