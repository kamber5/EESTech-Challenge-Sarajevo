    ...
    var body: some View {
        NavigationView {
            VStack {
                    ...
                    VStack {
                        VStack {
                            ...
                            .frame(width: getRelativeWidth(158.0), height: getRelativeWidth(158.0),
                                   alignment: .center)
                            .background(RoundedCorners(topLeft: 79.0, topRight: 79.0,
                                                       bottomLeft: 79.0, bottomRight: 79.0)
                                ...
                                ZStack(alignment: .center) {
                                    Image("img_vector_light_green_300")
                                        ...
                                        .background(RoundedCorners(topLeft: 25.0, topRight: 25.0,
                                                                   ...
                                                                   bottomRight: 25.0))
                                        .onTapGesture {
                                            mainPageViewModel.nextScreen = "PickobjectiveView"
                                        }
                                    Text(StringConstants.kLblPlayGame)
                                        .font(FontScheme
                                            .kPoppinsBold(size: getRelativeHeight(40.0)))
                                        .fontWeight(.bold)
                                        .foregroundColor(ColorConstants.Black900)
                                        .minimumScaleFactor(0.5)
                                        .multilineTextAlignment(.center)
                ...
                Group {
                    NavigationLink(destination: PickobjectiveView(),
                                   tag: "PickobjectiveView",
                                   selection: $mainPageViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
