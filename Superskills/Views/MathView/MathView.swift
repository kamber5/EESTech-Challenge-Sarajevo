...
struct MathView: View {
    @StateObject var mathViewModel = MathViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                VStack {
                    VStack {
                        VStack(alignment: .trailing, spacing: 0) {
                            ...
                            VStack {
                                Text(StringConstants.kLblHowMuchIs22)
                                    .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(35.0)))
                                    .fontWeight(.regular)
                                    .foregroundColor(ColorConstants.Black900)
                                    .minimumScaleFactor(0.5)
                                    .multilineTextAlignment(.center)
                                    .frame(width: 304.0, height: getRelativeHeight(38.0),
                                           alignment: .center)
                                    ...
                                    VStack {
                                        LazyVGrid(columns: [SwiftUI.GridItem(), SwiftUI.GridItem()],
                                            ...
                                            ForEach(0 ... 3, id: \.self) { index in
                                                Stackvector1Cell(vectorClick: {
                                                    mathViewModel.nextScreen = "MathTwoView"
                                                })
                                            }
                                        }
                                    }
                            ...
                            .frame(width: 314.0, height: getRelativeHeight(309.0),
                                   alignment: .center)
                ...
                Group {
                    NavigationLink(destination: MathTwoView(),
                                   tag: "MathTwoView",
                                   selection: $mathViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
